                ...
                <div class="row justify-content-end">
                    <div class="col-auto">
                        <button class="btn btn-primary btn-lg" type="button" data-bs-toggle="modal"
                            data-original-title="test" data-bs-target="#exampleModal">Create New Priority</button>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered display" id="basic-1">
                        ...
                        <tbody>
                            <tr v-for="list in lists" :key="list.id">
                                ...
                                <!-- <td v-if="list.isActive == true">Active </td>
                                <td v-else-if="list.isActive == false">Disabled</td> -->
                                <!-- <td>{{ list.isActive }}</td> -->
                                <td>
                                    <!-- Edit Icon -->
...
export default {
    ...
    methods: {
        ...
        async fetchLists() {
            try {
                const response = await axios.get('http://127.0.0.1:8000/api/admin/priority/fetch-all', {
        ...
        async createData() {
            ...
            axios.post('http://127.0.0.1:8000/api/admin/priority/create', newData, {
                headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + localStorage.getItem('HCA_TOKEN') }
            })
                .then(response => {
                    console.log('success')
                    ...
                    window.location.href = 'http://localhost:8080/admin/priority'
        ...
        async updateData() {
            ...
            axios.post('http://127.0.0.1:8000/api/admin/priority/update', newData, {
                headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + localStorage.getItem('HCA_TOKEN') }
            })
                .then(response => {
                    console.log('success')
        ...
        async deleteData() {
            ...
            axios.post('http://127.0.0.1:8000/api/admin/priority/deactivate', itemData, {
                headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + localStorage.getItem('HCA_TOKEN') }
            })
                .then(response => {
                    console.log('success')
        ...
        num_pages() {
            return Math.ceil(this.lists.length / this.elementsPerPage);
        },
        change_page(page) {
