            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered display" id="basic-1">
                        ...
                        <tbody>
                            <tr v-for="role in lists" :key="role.id">
...
export default {
    ...
    methods: {
        ...
        async fetchList() {
            try {
                const response = await axios.get('http://127.0.0.1:8000/api/admin/incident-type/fetch-all', {
        ...
        async createData() {
            ...
            axios.post('http://127.0.0.1:8000/api/admin/incident-type/create', newData, {
                headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + localStorage.getItem('HCA_TOKEN') }
            })
                .then(response => {
                    console.log('success')
                    ...
                    window.location.href = 'http://localhost:8080/admin/incident-types'
        ...
        async updateData() {
            ...
            axios.post('http://127.0.0.1:8000/api/admin/incident-type/update', newData, {
                headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + localStorage.getItem('HCA_TOKEN') }
            })
                .then(response => {
                    console.log('success')
        ...
        async deleteData() {
            ...
            axios.post('http://127.0.0.1:8000/api/admin/incident-type/deactivate', itemData, {
                headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + localStorage.getItem('HCA_TOKEN') }
            })
                .then(response => {
                    console.log('success')
